...
plt.title('Shepp Logan Input and Target Image')
# plt.show()
...
mask_data_gen_args = dict(rotation_range=90,
                     ...
                     vertical_flip=True,
                     fill_mode='reflect',
                     preprocessing_function = lambda x: np.where(x>150, 1, 0).astype(x.dtype)) # 150 defined as the threshold for defining important pixels of target image
...
#If model has saved weights then skip training and use weights
if os.path.isfile('models/medseg_weights.h5') is False:
...
#IOU Intersection over Union. This is a method of comparing the target to the true value of our segmented image
