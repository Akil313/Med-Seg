# -*- coding: utf-8 -*-
"""
Created on Mon Oct 17 03:39:37 2022
...
#12 images only
large_image_stack = tiff.imread('images/training.tif')
large_mask_stack = tiff.imread('images/training_groundtruth.tif')

large_image_stack = large_image_stack[:12, :, :]
large_mask_stack = large_mask_stack[:12, :, :]
